<x-layouts.app :title="__('Companies')">
    <x-table :data="$companies" name="companies" />
    <el-dialog>
        <dialog id="dialog" aria-labelledby="dialog-title"
            ...
            <div tabindex="0"
                ...
                <el-dialog-panel
                        ...
                        <form id="newCompanyForm" method="POST" action="/companies">
                            @csrf
                            @method("POST")
                            <div class="bg-zinc-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                        <h3 id="dialog-title" class="text-base font-semibold text-white">Add new company</h3>
                                        <div class="mt-4">
                                            <flux:input type="text" name="name" id="name" class="mb-2"
                                                placeholder="Add Company Name" />
                                            <flux:input type="text" name="phone" id="phone" class="mb-2"
                                                placeholder="Add Company Phone Number" />
                                            <flux:input type="text" name="email" id="email"
